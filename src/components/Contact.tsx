    ...
    return(
        <div className="max-w-[1000px] mx-auto flex flex-col lg:flex-row text-white/70 p-8
            ...
            <div className='flex justify-center items-center'>
                <ul className='space-y-4'>
                    <li className='flex items-center'>
                        ...
                        <p className='text-xl'>+91 8767438912</p>
                    </li>
                    <li className='flex items-center'>
                        <Image src={mail} alt="mail" className='h-[110px] w-auto mr-6'/>
                        <p className='text-xl'>deveshingaleiiitm@gmail.com</p>
                    </li>
                </ul>
            </div>
            ...
            <div className='bg-white/10 p-6 rounded-xl max-w-[550px]'>
                ...
                <form className='space-y-4' action="https://getform.io/f/adrypjna" method="POST">
